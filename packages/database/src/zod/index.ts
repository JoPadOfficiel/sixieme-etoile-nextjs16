...
export const OrderScalarFieldEnumSchema = z.enum(['id','organizationId','reference','contactId','status','notes','createdAt','updatedAt']);
...
export const PricingModeSchema = z.enum(['FIXED_GRID','DYNAMIC','PARTNER_GRID','CLIENT_DIRECT','MANUAL']);
...
export const OrderStatusSchema = z.enum(['DRAFT','QUOTED','CONFIRMED','INVOICED','PAID','CANCELLED']);
...
/**
 * Order - Story 28.1: Central "Dossier de Commande" entity
 * Groups quotes, missions, and invoices under a single parent
 */
...
export const QuoteSchema = z.object({
  ...
  partnerGridPrice: z.instanceof(Prisma.Decimal, { message: "Field 'partnerGridPrice' must be a Decimal. Location: ['Models', 'Quote']"}).nullable(),
  clientDirectPrice: z.instanceof(Prisma.Decimal, { message: "Field 'clientDirectPrice' must be a Decimal. Location: ['Models', 'Quote']"}).nullable(),
  ...
  estimatedEndAt: z.coerce.date().nullable(),
  notes: z.string().nullable(),
