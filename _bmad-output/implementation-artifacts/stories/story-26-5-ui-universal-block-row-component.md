...
- [x] **Component Structure**: `UniversalLineItemRow` is created and exported.
- [x] **Type Rendering**: Component correctly applies specific styles/icons for CALCULATED, MANUAL, and GROUP types.
- [x] **Indentation**: Visual hierarchy is clear based on the `depth` prop.
- [x] **Inputs**: Label, Quantity, Unit Price, and VAT fields are present and trigger `onUpdate`.
- [x] **Calculated Indicator**: A specific icon/tooltip renders for CALCULATED lines to indicate source data presence.
- [x] **Group Header**: GROUP lines render as section headers with visually distinct styling.
